  ...
  return (
    <>
      ...
      <div className="terms-conditions">
        <TopHeading heading={"Terms and Conditions"} />
       <div className="terms-container container">
        <h4 className="terms-heading">KFC TERMS OF USE</h4>
        <h5 className="terms-h4">
      ...
      <div className="gap-extra-div">
        <div className="terms-div">
          <h6 className="terms-small-heading">
        ...
        <div className="terms-div">
          <h6 className="terms-small-heading">COMMUNICATING WITH KFC</h6>
          <p className="terms-para">
        ...
        <div className="terms-div">
          <h6 className="terms-small heading">KFC PROPERTY</h6>
          <p className="terms-para">
        ...
        <div className="terms-div">
          <h6 className="terms-small-heading">USER-SUBMITTED CONTENT</h6>
          <p className="terms-para">
        ...
        <div className="terms-div">
          <h6 className="terms-heading">ONLINE PURCHASES</h6>
          <p className="terms-para">
        ...
        <div className="terms-div">
          <h6 className="terms-small-heading">WEB SITE ACCESS</h6>
          <p className="terms-para">
        ...
        <div className="terms-div">
          <h6 className="terms-small-heading">INDEMNIFICATION</h6>
          <p className="terms-para">
        ...
        <div className="terms-div">
          <h6 className="terms-small-heading">HYPER-LINKS</h6>
          <p className="terms-para">
        ...
        <div className="terms-div">
          <h6 className="terms-small-heading">TEXT MESSAGING NOTICE</h6>
          <p className="terms-para">
        ...
        <div className="terms-heading">
          <h6 className="terms-heading">MISCELLANEOUS</h6>
          <p className="terms-para">
